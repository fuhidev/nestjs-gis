...
const bbox = '106.243069,11.510586,107.005245,10.878771';

@Injectable()
export class PlacesService {
  constructor() {}
  coordinatesToAddress(params: { lat:number,lng:number }):Promise<{
    display_name: string;
  }> {
  ...
  addressToCoordinates(params: { searchText: string }):Promise<FeatureCollection<any>> {
